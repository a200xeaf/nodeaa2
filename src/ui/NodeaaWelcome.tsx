...
const NodeaaWelcome = () => {
    ...
    return (
        <AlertDialog defaultOpen={true} open={welcomeDialog} onOpenChange={setWelcomeDialog}>
            <AlertDialogContent className="absolute z-9999 w-[90%] max-w-[1000px] max-h-[90vh] min-w-[100px] min-h-[20px]">
                <AlertDialogHeader className="items-center">
                    <AlertDialogTitle
                        className="inline-block w-fit text-4xl font-bold text-center select-none
                    bg-linear-to-r from-blue-500 to-pink-500 bg-clip-text text-transparent animate-gradient bg-[length:150%_150%]"
                    >
                        Welcome to Nodeaa
                    </AlertDialogTitle>
                    <AlertDialogDescription className="text-center select-none">
                        ...
                        <CarouselContent>
                            ...
                            <CarouselItem className="h-full flex flex-col md:flex-row items-center">
                                <div className="w-full md:w-1/3 text-left p-4">
                                    ...
                                    <p className="text-md text-gray-600 mt-2 select-none">
                                        ...
                                        key on the grid will bring up the Node search box. Type in the name of the node
                                        to create and either select one of the options or press enter to get the top
                                        selected option. Nodes can be dragged by the title bar at their tops. Nodes can
                                        be selected by clicking anywhere on them.
                                    </p>
                                </div>
                            ...
                            <CarouselItem className="h-full flex flex-col md:flex-row items-center">
                                ...
                                <div className="w-full md:w-1/3 text-left p-4">
                                    ...
                                    <p className="text-md text-gray-600 mt-2 select-none">
                                        Connect nodes by dragging either their inlet or outlet to a same colored port on
                                        another node. This will create a wire indicating the connection is working.
                                        Select cables and press{" "}
                                        <em>
                                        ...
                                        to disconnect the two nodes from each other.
                                    </p>
                                </div>
                            </CarouselItem>
                            ...
                            <CarouselItem className="h-full flex flex-col md:flex-row items-center">
                                <div className="w-full md:w-1/3 text-left p-4">
                                    ...
                                    <p className="text-md text-gray-600 mt-2 select-none">
                                        ...
                                        button in the top menu to report bugs or suggest new features.
                                    </p>
