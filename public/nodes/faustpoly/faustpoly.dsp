...
gate = button("gate") : en.adsr(attack, decay, sustain, release);

attack = hslider("attack", 0.1, 0.0, 5.0, 0.01) : si.smoo;
decay = hslider("decay", 0.1, 0.0, 5.0, 0.01) : si.smoo;
sustain = hslider("sustain", 0.7, 0.0, 1.0, 0.01) : si.smoo;
release = hslider("release", 0.1, 0.0, 5.0, 0.01) : si.smoo;
